...
public class AvgTripDistance_Q5A {
    ...
    public static class AverageTripDistancePerHourMapper extends Mapper<Object, Text, Text, DoubleWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            Text distanceKey = new Text("Distance");
            ...
            if (!columns[0].trim().isEmpty()) {
                ...
                try {
                    ...
                    // map hour_distancekey to distance to calculate per hour
                    context.write(new Text(hourVal + "_" + distanceKey),
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "average trip distance per hour");
        job.setJarByClass(AvgTripDistance_Q5A.class);
